...
<html lang="en">
	...
	<body>
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="container">
				<div class="row">
					<div class='col-xs-3'><?php echo ($vo["id"]); ?></div>
					<div class='col-xs-3'><?php echo ($vo["name"]); ?></div>
					<div class='col-xs-3'><?php echo ($vo["phonenum"]); ?></div>
					<div class='col-xs-3'><button class="btn btn-warning" id="btnDeleteById" )">删除</button></div>
				</div>
			</div><?php endforeach; endif; else: echo "" ;endif; ?>
		<div class="container">
			<div class="row">
				<div class="col-xs-12"><button class="btn btn-danger" id="deleteAll" style="margin:0 auto ;height:100% ;width: 100%; ">删除全部</button></div>
			</div>
		</div>
